// src/features/accounting/pages/accounts-payable/APAgingReportPage.tsx
import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import DashboardLayout from '../../../../layouts/DashboardLayout';
import { useAppSelector } from '../../../../app/hooks';
import type { RootState } from '../../../../app/store';
import { useGetAPAgingReportQuery } from '../../../../services/accountingApi';
...
export default function APAgingReportPage() {
  ...
  const { data, isLoading, refetch } = useGetAPAgingReportQuery({
      ...
      <div className="space-y-4 sm:space-y-6 px-4 sm:px-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900">AP Aging Report</h1>
              <p className="text-xs sm:text-sm text-gray-500 mt-1">Accounts Payable aging summary</p>
            </div>
          </div>
          <button
            onClick={() => refetch()}
