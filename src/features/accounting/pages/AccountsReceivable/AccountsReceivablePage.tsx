      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:space-x-2">
            <button
              onClick={() =>
                navigate(`${basePath}/accounting/accounts-receivable/create`)
              }
            ...
            <button
              onClick={() =>
                navigate(
                  `${basePath}/accounting/accounts-receivable/aging-report`,
                )
              }
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 text-center">
                            <span
                              className={`px-2.5 py-1 rounded-full text-xs font-medium ${STATUS_COLORS[displayStatus]}`}
                            >
                              {displayStatus}
                            </span>
                          </td>
