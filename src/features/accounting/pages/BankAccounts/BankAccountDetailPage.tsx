        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              onClick={() =>
                navigate(
                  `${basePath}/accounting/bank-accounts/edit/${account.id}`,
                )
              }
            ...
            <button
              onClick={() =>
                navigate(
                  `${basePath}/accounting/bank-accounts/${account.id}/statement`,
                )
              }
            ...
            <button
              onClick={() =>
                navigate(
                  `${basePath}/accounting/bank-accounts/${id}/transactions/create`,
                )
              }
              className="flex items-center justify-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 border border-green-300 rounded-lg text-green-600 hover:bg-green-50 text-sm"
            >
            ...
            <button
              onClick={() =>
                navigate(
                  `${basePath}/accounting/bank-accounts/${account.id}/reconcile`,
                )
              }
                        ...
                        {transactions.map((trans: any) => (
                          <tr key={trans.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 whitespace-nowrap">
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${TRANSACTION_TYPE_COLORS[trans.transaction_type]}`}
                              >
                            ...
                            <td
                              className={`px-4 py-3 text-right text-sm font-mono font-semibold whitespace-nowrap ${
            ...
            {account.glAccount && (
              <div className="bg-white rounded-xl p-4 sm:p-6">
                ...
                <button
                  onClick={() =>
                    navigate(
                      `${basePath}/accounting/chart-of-accounts/${account.gl_account_id}`,
                    )
                  }
                  className="text-left w-full p-3 rounded-lg hover:bg-gray-50 transition-colors"
                >
                  <p className="text-sm font-medium text-blue-600">
                    {account.glAccount.account_code}
                  </p>
                  <p className="text-sm text-gray-900 mt-1 break-words">
                    {account.glAccount.account_name}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                    {account.glAccount.account_type}
                  </p>
                </button>
              </div>
            )}
