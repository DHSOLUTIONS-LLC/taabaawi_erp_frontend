  ...
  const getExportData = () => {
    ...
    switch (activeTab) {
      ...
      case "profit-loss": {
        ...
        const expenseRows =
          report.operating_expenses?.details?.map((item: any) => [
            item.account_code,
            item.account_name,
            "Expense",
            item.amount.toFixed(3),
        ...
        const cogsRows =
          report.cost_of_goods_sold?.details?.map((item: any) => [
            item.account_code,
            item.account_name,
            "COGS",
            item.amount.toFixed(3),
        ...
        return {
          ...
          rows: [
            ...
            [
              ...
              "",
              "Gross Profit",
              report.gross_profit?.toFixed(3) || "0.000",
            ],
            ...expenseRows,
        ...
        return {
          ...
          rows: [
            ...
            [
              "Total Liabilities",
              "",
              report.liabilities?.total?.toFixed(3) || "0.000",
            ],
            ...equityRows,
        ...
        return {
          ...
          rows: [
            [
              ...
              report.operating_activities?.net_income?.toFixed(3) || "0.000",
            ],
            [
              "Operating Activities - Adjustments",
              report.operating_activities?.adjustments?.toFixed(3) || "0.000",
            ],
            [
              "Operating Activities - Working Capital Changes",
              report.operating_activities?.working_capital_changes?.toFixed(
                3,
              ) || "0.000",
            ],
            [
              "Net Cash from Operations",
              report.operating_activities?.net_cash?.toFixed(3) || "0.000",
            ],
            [
            ...
            [
              ...
              report.investing_activities?.sale_assets?.toFixed(3) || "0.000",
            ],
            [
              "Net Cash from Investing",
              report.investing_activities?.net_cash?.toFixed(3) || "0.000",
            ],
            [
              "Financing Activities - Borrowings",
              report.financing_activities?.borrowings?.toFixed(3) || "0.000",
            ],
            [
              "Financing Activities - Repayments",
              report.financing_activities?.repayments?.toFixed(3) || "0.000",
            ],
            [
              "Net Cash from Financing",
              report.financing_activities?.net_cash?.toFixed(3) || "0.000",
            ],
              ...
              <table className="w-full min-w-[400px]">
                <tbody className="divide-y divide-gray-100">
                  ...
                  <tr className="border-t-2 border-gray-200 bg-gray-50">
                    <td colSpan={2} className="px-4 py-2 text-sm font-semibold">
                      Total Revenue
                    </td>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 md:gap-6">
              <div className="xl:col-span-4 overflow-x-auto">
                <table className="w-full min-w-[400px]">
                  <tbody className="divide-y divide-gray-100">
                    {report.cost_of_goods_sold.details.map(
          ...
          <div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 md:gap-6">
              <div className="xl:col-span-4 overflow-x-auto">
                <table className="w-full min-w-[400px]">
                  <tbody className="divide-y divide-gray-100">
                    {report.operating_expenses.details.map(
                      (item: any, index: number) => (
                        <tr key={index} className="hover:bg-gray-50">
                          <td className="px-4 py-2 text-sm text-gray-600">
                            {item.account_code}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <p className="text-base sm:text-lg font-bold whitespace-nowrap">
              KWD {num(report.opening_balance).toFixed(3)}
            </p>
          </div>
          <div className="bg-gray-50 rounded-lg p-3">
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            >
              KWD{" "}
              {(
                num(report.closing_balance) - num(report.opening_balance)
              ).toFixed(3)}
            </p>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {report.transactions?.map((trans: any, index: number) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2 text-sm font-mono text-blue-600 whitespace-nowrap">
                      {trans.journal_number}
                    </td>
            ...
            <div className="p-4 space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-sm font-mono font-medium text-gray-900">
                  KWD{" "}
                  {num(report?.operating_activities?.net_income || 0).toFixed(
                    3,
                  )}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-sm font-mono font-medium text-blue-600">
                  KWD{" "}
                  {num(report?.operating_activities?.adjustments || 0).toFixed(
                    3,
                  )}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-sm font-mono font-medium text-orange-600">
                  KWD{" "}
                  {num(
                    report?.operating_activities?.working_capital_changes || 0,
                  ).toFixed(3)}
                </span>
              </div>
            ...
            <div className="p-4 space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-sm font-mono font-medium text-red-600">
                  (KWD{" "}
                  {num(
                    report?.investing_activities?.purchase_assets || 0,
                  ).toFixed(3)}
                  )
                </span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-sm font-mono font-medium text-green-600">
                  KWD{" "}
                  {num(report?.investing_activities?.sale_assets || 0).toFixed(
                    3,
                  )}
                </span>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-4 space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-sm font-mono font-medium text-green-600">
                  KWD{" "}
                  {num(report?.financing_activities?.borrowings || 0).toFixed(
                    3,
                  )}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="text-sm font-mono font-medium text-red-600">
                  (KWD{" "}
                  {num(report?.financing_activities?.repayments || 0).toFixed(
                    3,
                  )}
                  )
                </span>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">
                View and analyze financial statements
              </p>
            </div>
          </div>
