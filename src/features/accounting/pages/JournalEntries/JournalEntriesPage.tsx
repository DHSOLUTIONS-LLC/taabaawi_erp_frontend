      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">Record and manage financial transactions</p>
          </div>
          <button
...
<div className="xl:col-span-4 overflow-x-auto">
              <table className="w-full min-w-[900px] lg:min-w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Journal #</th>
                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Date</th>
                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Description</th>
                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-right text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Debit</th>
                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-right text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Credit</th>
                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-center text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Status</th>
                    <th className="px-4 sm:px-6 py-3 sm:py-4 text-center text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Actions</th>
                  </tr>
                </thead>
                  ...
                  {journals.map((journal: any) => (
                    <tr key={journal.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 sm:px-6 py-3 sm:py-4">
                        <div className="text-sm text-gray-900 truncate max-w-[200px] sm:max-w-[300px] lg:max-w-[400px]" title={journal.description}>
                          {journal.description}
                        </div>
                        {journal.reference_number && (
                          <div className="text-xs text-gray-500 whitespace-nowrap">Ref: {journal.reference_number}</div>
                        )}
                      </td>
                      <td className="px-4 sm:px-6 py-3 sm:py-4 text-right text-sm font-mono text-gray-900 whitespace-nowrap">
