    ...
    <div className="grid grid-cols-3 gap-2 pt-2">
      <div className="text-center">
        ...
        <p className="text-sm font-semibold text-gray-700">
          {(member.lifetime_points ?? 0).toLocaleString()}
        </p>
      </div>
      <div className="text-center">
      ...
      <div className="text-center">
        ...
        <p className="text-sm font-semibold text-gray-700">
          {member.total_spent ? `$${member.total_spent.toLocaleString()}` : "0"}
        </p>
      </div>
    </div>
  </div>
            ...
            <StatCard
              ...
              value={
                stats?.total_spent_all
                  ? `$${stats.total_spent_all.toLocaleString()}`
                  : "0"
              }
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-100">
                  {loyaltyLoading || statsLoading
                    ...
                    : (loyalty?.top_members ?? stats?.top_customers ?? [])
                        .slice(0, 5)
                        .map((m: any, i: number) => (
                          <tr
                            key={m.id}
                            ...
                            onClick={() =>
                              navigate(`${basePath}/crm/customers/${m.id}`)
                            }
                          >
