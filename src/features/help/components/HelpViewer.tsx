  ...
  if (!videoId || error) {
    return (
      <div className="bg-gray-100 rounded-lg p-8 text-center">
        <p className="text-gray-500">Video not available. Please check the URL.</p>
        <a href={url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm mt-2 inline-block">
    ...
    return (
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="prose max-w-none mb-6 overflow-x-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between pt-4 border-t border-gray-200 gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all"
              >
      ...
      {imageUrl && (
        <div className="relative w-full bg-gray-100">
          ...
          <img
            ...
            className={`w-full max-h-[300px] md:max-h-[400px] object-cover transition-opacity duration-300 ${isImageLoaded ? 'opacity-100' : 'opacity-0'
              }`}
      ...
      <div className="p-4 sm:p-6 md:p-8">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4">
          ...
          {article.difficulty_level && (
            <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${article.difficulty_level === 'Beginner' ? 'bg-green-100 text-green-700' :
        ...
        {/* Summary/Excerpt */}
        {article.summary && (
          <div className="text-base sm:text-lg text-gray-600 mb-6 pb-6 border-b border-gray-200 italic">
            {article.summary}
          </div>
        )}
