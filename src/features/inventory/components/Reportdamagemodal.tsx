...
useEffect(() => {
    ...
    return (
        <>
            ...
            {/* Modal */}
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-200 bg-white rounded-2xl shadow-2xl z-[70] flex flex-col max-h-[90vh]">
                    ...
                    <div className="space-y-4">
                        ...
                        {selectedSourceBranch && selectedDestBranch && (
                            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                <h4 className="text-sm font-medium text-orange-800 mb-2">Transfer Summary</h4>
                        ...
                        {branchStock.length > 0 && (
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <h4 className="text-sm font-medium text-gray-700 mb-2">Stock by Branch:</h4>
                                <div className="space-y-2 max-h-32 overflow-y-auto">
                                    {branchStock.map((branch) => (
                                        <div key={branch.branch_id} className="flex justify-between text-sm">
                ...
                <div className="px-8 py-6 border-t border-gray-200 shrink-0 bg-white rounded-b-2xl">
                    <div className="grid grid-cols-2 gap-4">
                        <button
                            ...
                            className="px-6 py-3 bg-[#1773CF33] cursor-pointer text-gray-700 font-semibold rounded-lg hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className="px-6 py-3 bg-[#F5AC68] cursor-pointer text-black font-semibold rounded-lg hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                        >
                            {isTransferring ? (
                                <>
                                    <svg
