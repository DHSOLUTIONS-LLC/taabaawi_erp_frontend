  ...
  const handleExportToExcel = () => {
    ...
    try {
      ...
      const nonDPPRData = nonDPPROrders.map((s: any) => ({
        ...
        "Status": s.status || "—",
        "Subtotal (KWD)": parseFloat(s.subtotal || "0").toFixed(3),
        "Discount (KWD)": parseFloat(s.discount_amount || "0").toFixed(3),
        "Coupon Discount (KWD)": parseFloat(s.coupon_discount || "0").toFixed(3),
        "Employee Discount (KWD)": parseFloat(s.employee_discount_amount || "0").toFixed(3),
        "Total (KWD)": parseFloat(s.total_amount || "0").toFixed(3),
        "Cash Received (KWD)": s.cash_received ? parseFloat(s.cash_received).toFixed(3) : "—",
        "Change Given (KWD)": s.change_given ? parseFloat(s.change_given).toFixed(3) : "—",
...
//       "Subtotal (KWD)": 15,
//       "Discount (KWD)": 15,
//       "Coupon Discount (KWD)": 20,
//       "Employee Discount (KWD)": 22,
//       "Total (KWD)": 15,
//       "Cash Received (KWD)": 18,
//       "Change Given (KWD)": 18,
//       "Card Reference": 20,
//       "Coupon Code": 18,
//       "Items Count": 12,
