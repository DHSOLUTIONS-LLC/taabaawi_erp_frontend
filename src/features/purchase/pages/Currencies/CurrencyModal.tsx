                ...
                <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                  {searchResults.map((curr) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-3 hover:bg-gray-50 focus:bg-gray-50 border-b last:border-b-0"
                    >
                      <div className="font-medium text-gray-900">{curr.code} - {curr.name}</div>
