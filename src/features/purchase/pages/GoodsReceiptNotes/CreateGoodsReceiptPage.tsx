...
const otherPOs = allPOs.filter((p: any) => 
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Receive items from a purchase order</p>
          </div>
        </div>
  ...
  className={`w-full px-4 py-3 border rounded-lg appearance-none bg-white pr-10 focus:ring-2 focus:ring-blue-500 ${
        ...
        <optgroup label="⛔ Cannot Receive (Wrong Status)">
          {otherPOs.map((p: any) => (
            <option key={p.id} value={p.id} disabled className="text-gray-400">
              ...
              {/* PO Info */}
              {po && (
                <div className="mt-4 p-4 bg-blue-50 rounded-lg grid grid-cols-3 gap-4 text-sm">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-blue-700">{po.currency} {(po.total_amount || 0).toFixed(3)}</p>
                  </div>
                  <div>
            ...
            {po && items.length > 0 && (
              <div className="bg-white rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  {hasDiscrepancy && (
                    <div className="flex items-center gap-2 text-yellow-600 bg-yellow-50 px-3 py-1.5 rounded-lg text-sm">
                      <img src={warning_icon} alt="" className="w-4 h-4" />
                ...
                <div className="space-y-4">
                  {items.map((item, idx) => {
                    ...
                    return (
                      <div key={item.po_item_id} className="border border-gray-200 rounded-xl p-4">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="text-right">
                            <p className="text-sm text-gray-600">Ordered: {item.quantity_ordered}</p>
                            <p className="text-sm text-gray-600">Previously Received: {item.quantity_received}</p>
                            <p className="text-sm font-semibold text-blue-600">Remaining: {remaining}</p>
                          </div>
                        </div>
