      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          <button onClick={() => navigate(`${basePath}/purchase/orders`)}>
            <img src={arrow_back_icon} alt="Back" className="w-8 h-8" />
          </button>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* Order Date */}
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Order Date</label>
                  <input
                    type="date"
                    value={orderDate}
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              {selectedProducts.length === 0 ? (
                <div
                  onClick={() => setShowProductModal(true)}
                  className="bg-gray-50 rounded-lg p-10 text-center border-2 border-dashed border-gray-200 cursor-pointer hover:border-blue-300 hover:bg-blue-50/30 transition-colors"
                >
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                    <img src={add_icon} alt="" className="w-6 h-6" />
                  </div>
                  <p className="text-gray-500 font-medium">No products added yet</p>
                  <p className="text-sm text-gray-400 mt-1">Click here or "Add Product" to get started</p>
                </div>
              ) : (
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 border-y border-gray-200">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-right  text-xs font-semibold text-gray-600 uppercase">Disc %</th>
                          ...
                          <tr key={product.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3">
                              <div className="flex justify-center">
                                <input
                                  ...
                                  className="w-20 px-2 py-1.5 border border-gray-300 rounded text-center text-sm focus:ring-1 focus:ring-blue-500"
                                />
                              </div>
                            </td>
                            <td className="px-4 py-3 text-right">
                              <input
                                ...
                                className="w-24 px-2 py-1.5 border border-gray-300 rounded text-right text-sm focus:ring-1 focus:ring-blue-500"
                              />
                            </td>
                            <td className="px-4 py-3 text-right">
                              <div className="flex items-center justify-end gap-1">
                                <input
                                  ...
                                  className="w-16 px-2 py-1.5 border border-gray-300 rounded text-right text-sm focus:ring-1 focus:ring-blue-500"
                                />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{currency} {subtotal.toFixed(3)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Discount</span>
                  <span className="font-medium text-red-600">− {currency} {discount.toFixed(3)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Tax</span>
                  <span className="font-medium">{currency} {tax.toFixed(3)}</span>
                </div>
                <div className="flex justify-between text-sm items-center">
                  ...
                  <input
                    ...
                    className="w-28 px-2 py-1 border border-gray-300 rounded text-right text-sm focus:ring-1 focus:ring-blue-500"
                  />
                </div>
                <div className="flex justify-between pt-3 border-t border-gray-200">
                  <span className="text-sm font-semibold">Grand Total</span>
                  <span className="text-lg font-bold text-blue-600">{currency} {total.toFixed(3)}</span>
                </div>
            ...
            {/* Terms & Notes */}
            <div className="bg-white rounded-xl p-6">
              <h2 className="text-base font-semibold text-gray-900 mb-4">Terms & Notes</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg resize-none text-sm focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Internal Notes</label>
                  <textarea
                    value={notes} rows={3}
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="py-3 border border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                disabled={isLoading}
                className="py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
              >
                {isLoading && (
