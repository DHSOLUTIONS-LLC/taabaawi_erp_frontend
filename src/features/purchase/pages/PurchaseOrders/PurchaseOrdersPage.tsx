              ...
              <div className="xl:col-span-4 overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      <th className="px-3 py-2 md:px-6 md:py-4 text-left text-xs font-semibold text-gray-600 uppercase">
                        PO Number
                      </th>
                      <th className="px-3 py-2 md:px-6 md:py-4 text-left text-xs font-semibold text-gray-600 uppercase">
                        Supplier
                      ...
                      <th className="px-3 py-2 md:px-6 md:py-4 text-right text-xs font-semibold text-gray-600 uppercase">
                        Total
                      </th>
                      <th className="px-3 py-2 md:px-6 md:py-4 text-center text-xs font-semibold text-gray-600 uppercase">
                        Status
                      </th>
                      <th className="px-3 py-2 md:px-6 md:py-4 text-center text-xs font-semibold text-gray-600 uppercase">
                        Payment
                            ...
                            {po.status === "Draft" && (
                              <>
                                <button
                                  onClick={() =>
                                    navigate(
                                      `${basePath}/purchase/orders/edit/${po.id}`,
                                    )
                                  }
