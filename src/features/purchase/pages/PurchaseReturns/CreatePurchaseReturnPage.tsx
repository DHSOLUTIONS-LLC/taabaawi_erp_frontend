    ...
    <DashboardLayout>
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Create Purchase Return</h1>
            <p className="text-sm text-gray-500 mt-0.5">Return items from a received purchase order</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              {/* PO Quick Info */}
              {po && (
                <div className="mt-4 p-4 bg-blue-50 rounded-lg grid grid-cols-3 gap-3 text-sm">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-blue-700">{po.currency} {parseFloat(String(po.total_amount)).toFixed(3)}</p>
                  </div>
                  <div>
                            ...
                            <div className="mt-3 flex items-center gap-3" onClick={(e) => e.stopPropagation()}>
                              ...
                              <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                                ...
                                <input
                                  ...
                                  className="w-12 h-8 text-center text-sm border-0 focus:ring-0 focus:outline-none"
                                />
                                <button
                                  type="button"
                                  onClick={() => updateQty(idx, item.return_quantity + 1)}
