          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-3">
                <h1 className="text-2xl font-bold text-gray-900">{purchaseReturn.return_number}</h1>
                <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${STATUS_COLORS[purchaseReturn.status] ?? 'bg-gray-100 text-gray-700'}`}>
          ...
          <div className="col-span-2 space-y-6">
            ...
            {purchaseReturn.reason_details && (
              <div className="bg-white rounded-xl p-6">
                ...
                <p className="text-sm text-gray-700 whitespace-pre-wrap">{purchaseReturn.reason_details}</p>
              </div>
            )}
          </div>
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                {purchaseReturn.status === 'Rejected' && (
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center text-xs font-bold shrink-0">✗</div>
                ...
                <div className="space-y-2">
                  ...
                  {purchaseReturn.supplier.email && (
                    <div>
                      ...
                      <p className="text-sm text-gray-900">{purchaseReturn.supplier.email}</p>
                    </div>
                  )}
                </div>
              ) : (
                <p className="text-sm text-gray-500">Supplier #{purchaseReturn.supplier_id}</p>
              )}
            </div>
              ...
              <div className="space-y-3">
                ...
                {purchaseReturn.approvedBy && (
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm">{purchaseReturn.approvedBy.name}</span>
                  </div>
                )}
              </div>
            </div>
