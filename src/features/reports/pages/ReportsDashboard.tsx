        ...
        <div className="max-w-full mx-auto xl:px-4 2xl:py-4">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Pre-built reports, saved reports and KPI metrics
            </p>
          </div>
          ...
          <div className="sm:hidden mb-4">
            ...
            >
              <div className="flex items-center gap-2">
                {(() => {
                  const Icon =
                    TABS.find((t) => t.id === activeTab)?.icon || BarChart2;
              ...
              <ChevronDown
                className={`w-4 h-4 text-gray-500 transition-transform duration-200 ${mobileMenuOpen ? "rotate-180" : ""}`}
              />
            </button>
              ...
              <>
                ...
                <div className="absolute left-4 right-4 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-20">
                  {TABS.map(({ id, label, icon: Icon }) => (
                    ...
                    >
                      <Icon
                        className={`h-4 w-4 ${activeTab === id ? "text-blue-600" : "text-gray-400"}`}
                      />
