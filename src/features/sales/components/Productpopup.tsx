    ...
    >
      ...
      {showSuccess && (
        <div className="absolute inset-0 bg-white/95 rounded-xl sm:rounded-2xl flex items-center justify-center z-10 animate-fadeIn">
          <div className="flex flex-col items-center gap-3 sm:gap-4">
            <img src={add_product_icon} alt="" className="w-12 h-12 sm:w-auto sm:h-auto" />
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 mb-3 sm:mb-4">
        <div className="w-full sm:w-auto">
          <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 break-words pr-2">{product.name}</h2>
