...
export default function AddOrderProducts() {
  ...
  const orderProducts = useAppSelector((state: RootState) => state.sales.orderProducts);
  ...
  <div className="max-w-[1920px] mx-auto px-3 sm:px-4 md:px-6 mb-4">
    ...
    <div className="flex flex-row justify-between items-center gap-3 sm:gap-4 mb-4 sm:mb-6 md:mb-8">
      <button onClick={handleBack} className="flex-shrink-0">
        <img src={arrow_back_icon} alt="" className="w-6 h-6 sm:w-7 md:w-8 md:h-8" />
      </button>
      <button
    ...
    <div className="relative">
      ...
      />
      <button className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 sm:p-2 hover:bg-gray-100 rounded-lg transition-colors" title="Scan Barcode">
  ...
  <div className="p-2 sm:p-3 md:p-4 lg:p-6">
    ...
    {filteredProducts.length === 0 && !isLoading && (
      <div className="flex flex-col items-center justify-center py-12 sm:py-16 md:py-20 px-4">
        ...
        <p className="text-sm sm:text-base text-gray-600 text-center max-w-sm px-4">Try adjusting your search or filter.</p>
      </div>
    )}
