          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 appearance-none bg-white pr-10 ${
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">State/Governorate</label>
                  <input
                    type="text"
                    value={shippingState}
...
/>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Coupon Code</label>
                  <input
                    type="text"
                    value={couponCode}
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Shipping Method *</label>
                  <div className="relative">
                    <select
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Shipping Fee (KWD)</label>
                  <input
                    type="number"
                    step="0.001"
                    value={shippingFee}
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between pt-3 border-t border-gray-200">
                  ...
                  <span className="text-lg font-bold text-blue-600">KWD {grandTotal.toFixed(3)}</span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4 pb-8">
          <button
            ...
            className="py-3.5 border border-gray-300 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            disabled={isCreating}
            className="py-3.5 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 disabled:opacity-50 transition-colors"
          >
