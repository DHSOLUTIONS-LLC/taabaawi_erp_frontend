...
export default function OrdersPage() {
  ...
  const filteredOrders = orders.filter(
    (order: any) =>
      order.channel === "Website" || order.channel === "Mobile App",
  );
  ...
  const handleExportPdf = () => {
    ...
    try {
      ...
      doc.text(`Total Orders: ${filteredOrders.length}`, 250, yPos, {
        align: "right",
      });
      yPos += 8;
      ...
      // Draw table rows
      filteredOrders.forEach((order: any, rowIndex: number) => {
                    ...
                    filteredOrders.map((order: any) => (
                      ...
                      >
                        <td
                          ...
                          onClick={() =>
                            navigate(
                              `${basePath}/sales/online_orders/${order.id}`,
                            )
                          }
                        >
                          {order.order_number}
