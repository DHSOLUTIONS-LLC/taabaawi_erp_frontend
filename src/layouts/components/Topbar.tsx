...
export default function Topbar({ pageTitle = "Dashboard Overview", toggleMobileMenu, mobileMenuOpen }: TopbarProps) {
  ...
  const handleBranchSelect = (branchId: number | null) => {
    ...
    dispatch(api.util.invalidateTags([
      ...
      'Suppliers', 'Payroll', 'Attendance', 'Employee', 'Staff',
      'JournalEntries', 'BankAccounts', 'BankTransactions', 'ChartOfAccounts',
      'AccountsPayable', 'AccountsReceivable', 'Budgets',
      'Reports', 'Dashboards', 'KpiMetrics',
      'POS', 'ShiftReports', 'Returns', 'Coupons',
      'Roles', 'Users', 'Branches', 'Permissions',
      'Customers', 'CustomerStatistics', 'LoyaltyStatistics', 'Loyalty',
      'ActivityLogs', 'LoginHistory', 'SecurityAlerts', 'UserSessions', 'DeletedRecords',
    ]));
              ...
              <>
                ...
                {showBranchDropdown && !branchesLoading && !branchesError && (
                  <>
                    ...
                    <div className="absolute left-0 mt-2 w-48 sm:w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                      <div className="p-2">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
          ...
          <div className="relative">
            <button
              ...
              className="p-1.5 sm:p-2 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors relative"
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                  <div className="p-2">
                    ...
                    <button onClick={handleLogout} className="w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded transition-colors">
                      Logout
                    </button>
                  </div>
                </div>
