...

  {
      ...
      // ── Admin Accounting ─────────────────────────────────────────────
      {
        ...
        children: [
          ...
          { path: 'journal-entries/create', element: <CreateJournalEntryPage /> },
          { path: 'journal-entries/:id', element: <JournalEntryDetailPage /> },
          { path: 'journal-entries/edit/:id', element: <EditJournalEntryPage /> },
          // Bank Accounts
          { path: 'bank-accounts', element: <BankAccountsPage /> },
          { path: 'bank-accounts/create', element: <CreateBankAccountPage /> },
          { path: 'bank-accounts/:id/transactions/create', element: <CreateBankTransactionPage /> },
          { path: 'bank-accounts/edit/:id', element: <EditBankAccountPage /> },
          { path: 'bank-accounts/:id', element: <BankAccountDetailPage /> },
          { path: 'bank-accounts/:id/statement', element: <BankStatementPage /> },
          { path: 'bank-accounts/:id/reconcile', element: <BankReconciliationPage /> },
          // Accounts Payable
          ...
          { path: 'accounts-payable/aging-report', element: <APAgingReportPage /> },
          // Accounts Receivable
          ...
          { path: 'accounts-receivable/aging-report', element: <ARAgingReportPage /> },
          // Budgets
          ...
          { path: 'budgets/:id/budget-vs-actual', element: <BudgetVsActualPage /> },
          // Financial Reports
