...
export const api = createApi({
  ...
  tagTypes: ['Roles', 'Users', 'Branches','BranchUsers','BranchStatistics','DeletedBranches','BranchTypes', 'Permissions', 'Staff', 'Products','Attendance','Employee', 'LeaveRequest','Bonus','Payroll',
    'POS','ShiftReports','Sales','Returns','Coupons','Orders','ShippingMethods','Invoices','Suppliers','Currencies','PurchaseOrders','GoodsReceiptNotes',
    'PurchaseReturns','SupplierPayments','ChartOfAccounts','JournalEntries','BankAccounts','BankTransactions','AccountsPayable','AccountsReceivable',
