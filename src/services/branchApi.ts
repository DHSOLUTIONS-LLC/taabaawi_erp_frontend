...
export const branchApi = api.injectEndpoints({
  endpoints: (builder) => ({
    ...
    changeBranchStatus: builder.mutation<
      BranchResponse,
    ...
    getRetailBranches: builder.query<
    ...
    getBranchesWithPOS: builder.query<
      { success: boolean; data: Branch[] },
      void
    >({
    ...
    getTemporaryBranches: builder.query<
      { success: boolean; data: Branch[] },
      void
    >({
    ...
    getBranchesByType: builder.query<
      { success: boolean; data: Branch[] },
      string
    >({
