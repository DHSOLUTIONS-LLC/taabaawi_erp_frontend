...
export const inventoryApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        createStockTransfer: builder.mutation<any, {
        ...
        getInventoryMovements: builder.query<any, {
            page?: number;
            ...
            query: (params) => {
                ...
                if (params.from_branch_id) {
                    queryParams.append('from_branch_id', params.from_branch_id.toString());
                }
        ...
        reportDamagedItem: builder.mutation({
            query: (damagedItemData) => ({  // Changed from damagedItemsData to damagedItemData
                url: '/damaged-items',
                method: 'POST',
