...
export const posApi = api.injectEndpoints({
    endpoints: (builder) => ({
        ...
        addCashMovement: builder.mutation<any, {
            cash_register_id: number;
        ...
        getSalesStatistics: builder.query<any, {
            branch_id?: number;
            start_date?: string;
            end_date?: string;
        }>({
  ...
  query: (body) => ({
    ...
    body,
        ...
        getReturnStatistics: builder.query<any, {
            branch_id?: number;
            start_date?: string;
            end_date?: string;
        }>({
        ...
        updateCoupon: builder.mutation<any, { id: number; data: Partial<CreateCouponPayload> }>({
            query: ({ id, data }) => ({
                url: `/coupons/${id}`,
                method: 'PUT',
                body: data,
            }),
            invalidatesTags: (_result, _error, { id }) => [{ type: 'Coupons', id }, 'Coupons'],
        }),
        ...
        getShiftReports: builder.query<any, {
            branch_id?: number;
            user_id?: number;
            status?: string;
            start_date?: string;
        ...
        getDailyShiftSummary: builder.query<any, {
            date?: string;
            branch_id?: number;
        }>({
