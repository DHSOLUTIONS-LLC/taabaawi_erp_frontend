...
export const purchaseApi = api.injectEndpoints({
    endpoints: (builder) => ({
        // ==================== SUPPLIERS ====================
        getSuppliers: builder.query<{ data: Supplier[]; meta?: any }, {
            is_active?: boolean;
            rating?: string;
            country?: string;
            currency?: string;
        ...
        updateSupplier: builder.mutation<{ data: Supplier }, { id: number; data: Partial<Supplier> }>({
            query: ({ id, data }) => ({
                url: `/suppliers/${id}`,
                method: 'PUT',
                body: data,
    ...
    transformResponse: (response: any) => {
        ...
        updateCurrency: builder.mutation<{ data: Currency }, { id: number; data: Partial<Currency> }>({
            query: ({ id, data }) => ({
                url: `/currencies/${id}`,
                method: 'PUT',
                body: data,
        ...
        convertCurrency: builder.mutation<{ data: any }, { amount: number; from_currency: string; to_currency: string }>({
            query: (body) => ({
        ...
        // ==================== PURCHASE ORDERS ====================
        getPurchaseOrders: builder.query<{ data: PurchaseOrder[]; meta?: any }, {
            supplier_id?: number;
            branch_id?: number;
            status?: string;
    ...
    transformResponse: (response: any) => {
        ...
        const parseNum = (v: any) => (v !== null && v !== undefined ? parseFloat(v) || 0 : 0);
        ...
        updatePurchaseOrder: builder.mutation<{ data: PurchaseOrder }, { id: number; data: any }>({
            query: ({ id, data }) => ({
                url: `/purchase-orders/${id}`,
                method: 'PUT',
                body: data,
            }),
            invalidatesTags: (_r, _e, { id }) => [{ type: 'PurchaseOrders', id }, 'PurchaseOrders'],
        }),
        ...
        submitPurchaseOrderForApproval: builder.mutation<{ data: PurchaseOrder }, number>({
            query: (id) => ({
        ...
        rejectPurchaseOrder: builder.mutation<{ data: PurchaseOrder }, { id: number; reason: string }>({
            query: ({ id, reason }) => ({
        ...
        markPurchaseOrderAsOrdered: builder.mutation<{ data: PurchaseOrder }, number>({
            query: (id) => ({
        ...
        cancelPurchaseOrder: builder.mutation<{ data: PurchaseOrder }, { id: number; reason: string }>({
            query: ({ id, reason }) => ({
        ...
        getPurchaseOrderStatistics: builder.query<{ data: any }, {
            start_date?: string;
            end_date?: string;
            branch_id?: number;
        }>({
        ...
        getPendingApprovals: builder.query<{ data: PurchaseOrder[]; meta?: any }, {
            branch_id?: number;
            page?: number;
            per_page?: number;
        }>({
            query: (params) => ({ url: '/purchase-orders/pending-approvals', params }),
            providesTags: ['PurchaseOrders'],
        }),

        // ==================== GOODS RECEIPT NOTES ====================
        getGoodsReceiptNotes: builder.query<{ data: GoodsReceiptNote[]; meta?: any }, {
            purchase_order_id?: number;
            branch_id?: number;
            status?: string;
            start_date?: string;
        ...
        verifyGoodsReceiptNote: builder.mutation<{ data: GoodsReceiptNote }, number>({
            query: (id) => ({
        ...
        completeGoodsReceiptNote: builder.mutation<{ data: GoodsReceiptNote }, number>({
            query: (id) => ({
        ...
        // ==================== PURCHASE RETURNS ====================
        getPurchaseReturns: builder.query<{ data: PurchaseReturn[]; meta?: any }, {
            purchase_order_id?: number;
            supplier_id?: number;
            branch_id?: number;
            status?: string;
        ...
        rejectPurchaseReturn: builder.mutation<{ data: PurchaseReturn }, { id: number; reason: string }>({
            query: ({ id, reason }) => ({
        ...
        getPurchaseReturnStatistics: builder.query<{ data: any }, {
            start_date?: string;
            end_date?: string;
            branch_id?: number;
        }>({
        ...
        // ==================== SUPPLIER PAYMENTS ====================
        getSupplierPayments: builder.query<{ data: SupplierPayment[]; meta?: any }, {
            purchase_order_id?: number;
            supplier_id?: number;
        ...
        getSupplierPaymentStatistics: builder.query<{ data: any }, {
            start_date?: string;
            end_date?: string;
        }>({
